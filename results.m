function [MSE] = results(t, States, Sim_states, Benchmark_states, case_name)

Benchmark_states.psi_deg = unwrap(Benchmark_states.psi_deg);
...
plot(Benchmark_states.time, Benchmark_states.u, 'm');
...
plot(Benchmark_states.time, Benchmark_states.alpha_deg, 'm');
...
plot(Benchmark_states.time, Benchmark_states.beta_deg, 'm');
...
plot(Benchmark_states.time, rad2deg(Benchmark_states.p), 'm');
...
plot(Benchmark_states.time, rad2deg(Benchmark_states.q), 'm');
...
plot(Benchmark_states.time, rad2deg(Benchmark_states.r), 'm');
...
plot(Benchmark_states.time, Benchmark_states.phi_deg, 'm');
...
plot(Benchmark_states.time, Benchmark_states.theta_deg, 'm');
...
plot(Benchmark_states.time, Benchmark_states.psi_deg, 'm');
xlabel("$t$ [s]", 'interpreter', 'latex', 'fontSize', 12);
...
plot(Benchmark_states.time, Benchmark_states.x, 'm');
...
plot(Benchmark_states.time, Benchmark_states.y, 'm');
ylabel("$y_e$ $[ft]$", 'interpreter', 'latex', 'fontSize', 12);
legend("Matlab", "Simulink", "Benchmark Test", "Location", "southeast");
...
plot(Benchmark_states.time, Benchmark_states.z, 'm');
